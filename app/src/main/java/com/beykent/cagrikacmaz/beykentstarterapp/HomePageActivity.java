		...
		elvChapters.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
			public boolean onChildClick(ExpandableListView parent, View v,
                ...
                if (exerciseClass != null) {
                	Toast.makeText(HomePageActivity.this, exerciseTitle, Toast.LENGTH_LONG).show();
                	startActivity(new Intent(HomePageActivity.this, exerciseClass));
                } else {
                	Toast.makeText(HomePageActivity.this, "Şu an mevcut değil", Toast.LENGTH_SHORT).show();
            }
				return false;
			}
		});
